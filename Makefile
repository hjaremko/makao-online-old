...
g-client: src/graphics-client.cpp src/Card.cpp src/Deck.cpp src/PlayingStack.cpp src/HandDeck.cpp src/Player.cpp
	g++ -std=c++11 src/graphics-client.cpp src/Card.cpp src/Deck.cpp src/PlayingStack.cpp src/HandDeck.cpp src/Player.cpp -o graphics-client.out -Wall -O2 -lsfml-network -lsfml-graphics -lsfml-window -lsfml-system
