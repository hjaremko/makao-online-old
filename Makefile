...
g-client: src/graphics-client.cpp src/Card.cpp src/TextureCard.cpp src/TextureDeck.cpp src/Deck.cpp src/PlayingStack.cpp src/THandDeck.cpp src/HandDeck.cpp src/Player.cpp src/ChoiceMenu.cpp src/Text.cpp
	g++ -std=c++11 src/graphics-client.cpp src/Card.cpp src/TextureCard.cpp src/TextureDeck.cpp src/Deck.cpp src/PlayingStack.cpp src/THandDeck.cpp src/HandDeck.cpp src/Player.cpp src/ChoiceMenu.cpp src/Text.cpp -o graphics-client.out -Wall -O2 -lsfml-network -lsfml-graphics -lsfml-window -lsfml-system
